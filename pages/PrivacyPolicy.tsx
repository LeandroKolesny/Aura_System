      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          ...
          <Section title="1. Quem Somos">
            <p>O <strong>Aura System</strong> é uma plataforma digital de gestão para clínicas de estética.</p>
          ...
          <Section title="2. A Quem Esta Política se Aplica">
            ...
            <ul className="list-disc pl-5 space-y-1.5">
              ...
              <li><strong>Pacientes das Clínicas:</strong> Quando as clínicas inserem seus dados no sistema, o Aura System os trata como Operador;</li>
            ...
            <div className="bg-[#fdfcfb] border border-[#f0e8e0] rounded-xl p-3 text-xs mt-2">
              <strong>Importante para pacientes:</strong> Se você é paciente de uma clínica que usa o Aura System, seus dados são controlados <strong>pela clínica</strong>. Para exercer seus direitos (acesso, correção, exclusão), entre em contato diretamente com a clínica. O Aura System atuará como facilitador quando necessário.
            </div>
          </Section>
          ...
          <Section title="3. Papéis na Proteção de Dados">
            <div className="grid gap-3">
              <div className="bg-[#fdfcfb] border border-[#f0e8e0] rounded-xl p-3">
                <p className="font-semibold text-[#1c1917] text-xs mb-1">Aura System como Controlador</p>
                <p className="text-xs">Em relação aos dados dos <strong>usuários do sistema</strong> (profissionais e administradores), o Aura System decide como e por que esses dados são tratados.</p>
              </div>
              <div className="bg-[#fdfcfb] border border-[#f0e8e0] rounded-xl p-3">
                <p className="font-semibold text-[#1c1917] text-xs mb-1">Aura System como Operador</p>
                <p className="text-xs">Em relação aos <strong>dados dos pacientes</strong> inseridos pelas clínicas, o Aura System trata esses dados apenas a mando e conforme instruções da clínica cliente.</p>
              </div>
              <div className="bg-[#fdfcfb] border border-[#f0e8e0] rounded-xl p-3">
          ...
          <Section title="4. Quais Dados Coletamos e Por Quê">
            ...
            <p className="text-xs">Estes dados são inseridos pelas próprias clínicas. O Aura System suporta:</p>
          ...
          <Section title="5. Dados Sensíveis de Saúde — Proteção Especial">
            ...
            <div className="bg-[#fdfcfb] border border-[#f0e8e0] rounded-xl p-3 text-xs">
              <strong>Vedação absoluta (Art. 11, §4º LGPD):</strong> É proibido compartilhar dados sensíveis de saúde para obtenção de vantagem econômica. O Aura System confirma que <strong>nunca realiza e nunca realizará</strong> essa prática.
            </div>
          ...
          <Section title="6. Com Quem Compartilhamos os Dados">
            <p>O Aura System <strong>não vende dados</strong>. Dados são compartilhados somente com:</p>
            <ul className="list-disc pl-5 space-y-1.5">
          ...
          <div className="bg-[#fdfcfb] border border-[#f0e8e0] rounded-xl p-5">
            ...
            <dl className="grid grid-cols-1 gap-2 text-xs">
              {[
                ...
                ['Operador','Quem trata dados a mando do Controlador. O Aura System é o Operador dos dados dos pacientes.'],
