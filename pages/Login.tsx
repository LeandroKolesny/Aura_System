...
import { authApi, API_BASE_URL as API_URL } from '../services/api';
          ...
          {isRegistering ? (
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                ...
                <span className="text-xs text-secondary-600 leading-relaxed">
                  Quero receber novidades, dicas e atualizações do {SAAS_COMPANY_NAME} por email. <span className="text-secondary-400">(opcional)</span>
                </span>
              </label>
