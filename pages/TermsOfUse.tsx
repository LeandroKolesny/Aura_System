      ...
      <header className="bg-gradient-to-r from-[#bd7b65] to-[#8b5a47] py-10 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 mb-3">
            ...
            <span className="text-xl font-bold text-white">Aura System</span>
          </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          ...
          <Section title="1. Das Partes e Definições">
            <p><strong>1.1</strong> Estes Termos de Uso regulam a relação entre o <strong>Aura System</strong> (plataforma de gestão SaaS para clínicas de estética) e o <strong>Contratante</strong> (pessoa jurídica ou física que realiza o cadastro e utiliza os serviços).</p>
              ...
              <table className="w-full text-xs border-collapse mt-2">
                ...
                <tbody>
                  {[
                    ...
                    ['Operador', 'Quem trata dados em nome do Controlador — o Aura System, em relação aos dados das clínicas'],
          ...
          <Section title="2. Do Objeto e Aceite">
            <p><strong>2.1</strong> O Aura System é uma plataforma de gestão em nuvem (SaaS) para clínicas de estética, disponibilizando funcionalidades de agendamento online, cadastro de pacientes, prontuário eletrônico, controle financeiro, gestão de estoque, relatórios e demais ferramentas conforme o plano contratado.</p>
          ...
          <Section title="3. Do Cadastro e Acesso">
            ...
            <p><strong>3.3</strong> O Aura System reserva-se o direito de recusar cadastros com informações falsas ou incompletas.</p>
          </Section>
          ...
          <Section title="4. Das Obrigações do Contratante">
            ...
            <ul className="list-disc pl-5 space-y-1.5">
              ...
              <li><strong>Informação aos pacientes:</strong> Informar seus pacientes, em linguagem clara, sobre a utilização do sistema digital Aura System para armazenamento de seus dados (Art. 9º LGPD);</li>
              ...
              <li><strong>Notificação de incidentes:</strong> Comunicar imediatamente o Aura System em caso de acesso não autorizado.</li>
            </ul>
          ...
          <Section title="5. Das Obrigações do Aura System">
            <p>O Aura System compromete-se a:</p>
            <ul className="list-disc pl-5 space-y-1.5">
          ...
          <Section title="7. Da Propriedade Intelectual">
            <p><strong>7.1</strong> O Aura System e todos os seus componentes são de propriedade exclusiva do Aura System, protegidos pela Lei nº 9.610/1998 e demais normas de propriedade intelectual.</p>
            ...
            <p><strong>7.3</strong> Os <strong>dados inseridos pelo Contratante</strong> (dados dos pacientes, procedimentos, financeiro, etc.) pertencem ao Contratante e a seus pacientes. O Aura System não reivindica propriedade sobre esses dados.</p>
          </Section>

          <Section title="8. Da Proteção de Dados Pessoais (LGPD)">
            <p><strong>8.1 Papéis:</strong> O Contratante é o <strong>Controlador</strong> dos dados de seus pacientes. O Aura System é o <strong>Operador</strong>, tratando esses dados apenas conforme instruções do Contratante.</p>
            <p><strong>8.2 Dados Sensíveis:</strong> O Aura System reconhece que fichas de anamnese, prontuários, fotografias de procedimentos e histórico de saúde são dados sensíveis (Art. 5º, II e Art. 11 da LGPD) e adota proteção reforçada.</p>
            ...
            <p><strong>8.4 Vedação absoluta (Art. 11, §4º LGPD):</strong> É proibido o uso dos dados sensíveis de saúde para obtenção de vantagem econômica. O Aura System confirma que nunca realizará tal prática.</p>
          ...
          <Section title="10. Da Suspensão e Cancelamento">
            ...
            <p><strong>10.2</strong> O Aura System pode suspender o acesso em caso de inadimplência, violação grave destes Termos ou uso ilícito da Plataforma. Em risco imediato a dados de terceiros, a suspensão pode ser imediata.</p>
          </Section>
          ...
          <Section title="11. Da Portabilidade e Encerramento">
            ...
            <p><strong>11.2</strong> Após o cancelamento, os dados ficam disponíveis para exportação por <strong>30 dias</strong>. Após esse prazo, o Aura System realiza exclusão segura, mantendo apenas o exigido por lei (dados fiscais: 5 anos; logs: 6 meses — Marco Civil da Internet, Art. 15).</p>
          </Section>

          <Section title="12. Da Limitação de Responsabilidade">
            <p><strong>12.1</strong> A responsabilidade total do Aura System fica limitada ao valor pago pelo Contratante nos <strong>12 meses</strong> anteriores ao evento.</p>
            <p><strong>12.2</strong> O Aura System não se responsabiliza por danos indiretos, lucros cessantes, atos do Contratante que violem a LGPD, conteúdo inserido pelo Contratante, falhas de infraestrutura de terceiros ou eventos de força maior.</p>
          </Section>
        ...
        <div className="text-center mt-8 text-xs text-[#a09890] space-y-2">
          <p>© {new Date().getFullYear()} Aura System · Todos os direitos reservados</p>
